RESPONSE_OF_ENRICH_WITH_INVALID_OBS = {
    'code': 'invalid argument',
    'message': 'Invalid JSON Payload Received: {"0": {"value": ["Missing data for required field."]}}',
    'type': 'fatal'
}
    ...
    "data": [
                {
                    ...
                    "id": "ref-endace-search-ip-185.53.179.29",
                    "title": "Generate Pivot to EndaceVision link",
                    "url": "https://someprobe.endace.com/vision2/v1/pivotintovision/?datasources=tag%3Arotation-file%26reltime=10m%26title=Pivot%20from%20XDR%26ip=185.53.179.29%26tools=trafficOverTime_by_app%2CconversationsChords_by_ipaddress"
                }
            ]
}
